...
export const SEED_FINES: Fine[] = [
  { id: 1, who: 'A', by: 'S', rule: 'swear', label: 'Swearing', sev: 'unforgivable', amt: 3, when: '2 hours ago', day: 5 },
  { id: 2, who: 'S', by: 'S', rule: 'phone', label: 'Phone at dinner', sev: 'mild', amt: 2, when: 'Yesterday', day: 4 },
  { id: 3, who: 'A', by: 'S', rule: 'late', label: 'Late again', sev: 'bad', amt: 5, when: 'Yesterday', day: 4 },
  { id: 4, who: 'A', by: 'S', rule: 'swear', label: 'Swearing', sev: 'bad', amt: 2, when: 'Yesterday', day: 4 },
  { id: 5, who: 'A', by: 'S', rule: 'phone', label: 'Phone at dinner', sev: 'mild', amt: 2, when: 'Tuesday', day: 2 },
  { id: 6, who: 'S', by: 'S', rule: 'swear', label: 'Swearing', sev: 'mild', amt: 1, when: 'Tuesday', day: 2 },
  { id: 7, who: 'A', by: 'S', rule: 'late', label: 'Late again', sev: 'mild', amt: 2.5, when: 'Tuesday', day: 2 },
  { id: 8, who: 'A', by: 'S', rule: 'swear', label: 'Swearing', sev: 'bad', amt: 2, when: 'Monday', day: 1 },
  { id: 9, who: 'S', by: 'S', rule: 'late', label: 'Late again', sev: 'mild', amt: 2.5, when: 'Monday', day: 1 },
  { id: 10, who: 'A', by: 'S', rule: 'late', label: 'Late again', sev: 'unforgivable', amt: 7.5, when: 'Sunday', day: 0 },
  { id: 11, who: 'S', by: 'S', rule: 'phone', label: 'Phone at dinner', sev: 'bad', amt: 4, when: 'Sunday', day: 0 },
  { id: 12, who: 'A', by: 'S', rule: 'swear', label: 'Swearing', sev: 'mild', amt: 1, when: 'Saturday', day: 6 },
  { id: 13, who: 'S', by: 'S', rule: 'swear', label: 'Swearing', sev: 'bad', amt: 2, when: 'Saturday', day: 6 },
  { id: 14, who: 'A', by: 'S', rule: 'phone', label: 'Phone at dinner', sev: 'bad', amt: 4, when: 'Friday', day: 5 },
  { id: 15, who: 'S', by: 'S', rule: 'late', label: 'Late again', sev: 'bad', amt: 5, when: 'Thursday', day: 4 },
  { id: 16, who: 'A', by: 'S', rule: 'swear', label: 'Swearing', sev: 'bad', amt: 2, when: 'Thursday', day: 4 },
  { id: 17, who: 'S', by: 'S', rule: 'swear', label: 'Swearing', sev: 'mild', amt: 1, when: 'Wednesday', day: 3 },
];
